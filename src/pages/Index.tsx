  ...
  return (
    <div className="min-h-screen">
      ...
      <section ref={heroRef} className="relative min-h-screen flex items-center overflow-hidden">
        ...
        {/* MODIFIED: Reduced overlays to show the true video colors */}
        {/* This single overlay provides just enough contrast for the text while keeping the video bright */}
        ...
        >
          ...
          >
            ...
            <motion.h1 variants={fadeUp} className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 text-white">
              USA-Focused IT Staffing &{" "}
              <span className="text-gradient">Software Development</span>{" "}
              Solutions
            </motion.h1>
            <motion.p variants={fadeUp} className="text-lg md:text-xl text-white/90 max-w-2xl mb-10">
              We connect top tech talent with global business opportunities.
            </motion.p>
            <motion.div variants={fadeUp} className="flex flex-wrap gap-4">
              <Link
              ...
              <Link
                to="/careers"
                className="px-8 py-3.5 rounded-lg border border-white/50 text-white font-semibold hover:bg-white/10 transition-all"
              >
                Submit Resume
              </Link>
            </motion.div>

      ...
      <section className="section-padding bg-gradient-hero relative overflow-hidden">
        <div className="container mx-auto relative z-10">
          <motion.div initial="hidden" animate="visible" variants={stagger} className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div variants={fadeUp} className="rounded-2xl overflow-hidden glow-border">
      ...
      <section className="section-padding bg-background">
        <div className="container mx-auto">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyUs.map((item) => (
              <motion.div key={item.title} variants={fadeUp} className="glass-card hover-glow p-6 text-center">

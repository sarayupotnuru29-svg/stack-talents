        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              {/* 1. Increased logo size to h-14 w-14 */}
              <img src={logo} alt="Stack Talent" className="h-14 w-14 rounded-full object-cover" />
              <div>
            ...
            <p className="text-muted-foreground text-sm leading-relaxed">
              Built on tech. Driven by talent. 
              {/* 2. Added line break for the description */}
              <br />
              USA-focused IT staffing & software development solutions.
            </p>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              <a href="mailto:Hr@stacktalentits.com" className="flex items-center gap-2.5 text-sm text-muted-foreground hover:text-primary transition-colors">
                <Mail size={16} className="text-primary" /> Hr@stacktalentits.com
              </a>
